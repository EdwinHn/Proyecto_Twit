...
public class InternalEntrarPerfil extends javax.swing.JInternalFrame {
    ...
    private void btnBuscarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnBuscarMouseClicked
        String perfil = jTextFieldBuscarPerfil.getText(); // Obtiene el texto ingresado para buscar el perfil
        ...
        if (gestionCuentas.verificar(perfil)) {
            ...
            if (info != null) {
                jLabelUsername.setText(info.getusuario());
                jLabelNombre.setText(info.getnombre());
                jLabelEdadUsuario.setText(info.getedad());
                jLabelFechaUsuario.setText(info.getfecha());
                jLabelGeneroUsuario.setText(info.getgenero());

                String genero = jLabelGeneroUsuario.getText();

                jLabelSeguidores.setText("" + info.getSeguidores());
                jLabelSiguiendo.setText("" + info.getSeguidos().cantidadSeguidos());

                String[] timeline = info.obtenerTimeline();
                jTextAreaTwits.setText("");
                for (String tweet : timeline) {
                    jTextAreaTwits.append(tweet + "\n\n");

                }

                if (genero.equals("Masculino")) {
                    ImageIcon iconGenero = new ImageIcon("Hombre.png");
                    Image imgGenero = iconGenero.getImage();
                    Image imgScaleGenero = imgGenero.getScaledInstance(jLabelFoto.getWidth(), jLabelFoto.getHeight(), Image.SCALE_SMOOTH);
                    ImageIcon scaledIconGenero = new ImageIcon(imgScaleGenero);
                    jLabelFoto.setIcon(scaledIconGenero);

                } else if (genero.equals("Femenino")) {
                    ImageIcon iconGenero = new ImageIcon("Mujer.png");
                    Image imgGenero = iconGenero.getImage();
                    Image imgScaleGenero = imgGenero.getScaledInstance(jLabelFoto.getWidth(), jLabelFoto.getHeight(), Image.SCALE_SMOOTH);
                    ImageIcon scaledIconGenero = new ImageIcon(imgScaleGenero);
                    jLabelFoto.setIcon(scaledIconGenero);
                ...
                jLabelUsername.setText("No encontrado");
                jLabelNombre.setText("No encontrado");
                jLabelEdadUsuario.setText("No encontrado");
                jLabelFechaUsuario.setText("No encontrado");
                jLabelGeneroUsuario.setText("No encontrado");

                jLabelSeguidores.setText("");
                jLabelSiguiendo.setText("");

                // Limpiar el JTextArea
                jTextAreaTwits.setText("No se encontraron tweets.");
            }
        } else {
            jLabelUsername.setText("Usuario no existe");
